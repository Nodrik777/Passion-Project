...
namespace Passion.Controllers
{
    public class SpeciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SpeciesID,SpeciesClass")] Species species)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SpeciesID,SpeciesClass")] Species species)
        {
            if (ModelState.IsValid)
            {
